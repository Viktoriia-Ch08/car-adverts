import{u as o,d as r,r as g,j as t}from"./index-D0c2YMyW.js";const S="useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";let h=(e=21)=>{let i="",n=crypto.getRandomValues(new Uint8Array(e));for(;e--;)i+=S[n[e]&63];return i};const C="/car-adverts/assets/defaultImg-BDyUtCgQ.png",z=o.div`
  padding-top: 45px;
  padding-left: 10px;
  padding-right: 10px;
  margin-bottom: 10px;
...
`,pt=({data:e,favorite:i,setFavorite:n})=>t.jsx(dt,{children:e.map(s=>t.jsx(ct,{advert:s,favorite:i,setFavorite:n},`${s.id}${h()}`))});export{pt as C};
